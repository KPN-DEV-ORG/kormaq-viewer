...
function DicomUploadProgress({
  ...
  const getNumCompletedAndTimeRemainingComponent = (): ReactElement => {
    return (
      <div className="bg-muted flex h-14 items-center px-1 pb-4 text-lg text-foreground">
  ...
  return (
    <div className="flex grow flex-col">
      ...
      <div className="bg-background text-foreground flex grow flex-col overflow-hidden text-lg">
